...
D = [diff(gradAxu,x1),diff(gradAxu,x2),diff(gradAxu,x3),diff(gradAxu,x4)];
...
while f(n(1),n(2),n(3),n(4),l(1),l(2),l(3),l(4),u(1),u(2),C) > Fs && iter < MaxIter
    ...
    n = double(n - step*inv(D(n(1),n(2),n(3),n(4),l(1),l(2),l(3),l(4),u(1),u(2),C))*grad(n(1),n(2),n(3),n(4),l(1),l(2),l(3),l(4),u(1),u(2),C));
    C = 2*C;
